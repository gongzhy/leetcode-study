...
public class BinarySearch {
    ...
    public int search(int[] nums, int target) {
        return search(nums, target, 0, (0 + nums.length - 1) / 2, nums.length - 1);
    }


    private int search(int[] nums, int target, int leftIndex, int middleIndex, int rightIndex) {
        int value = nums[middleIndex];
        if (value == target) {
            return middleIndex;
        } else if (value > target) {
            int nextMiddleIndex = (leftIndex + middleIndex) / 2;
            if (nextMiddleIndex == leftIndex) {
            ...
            return search(nums, target, leftIndex, nextMiddleIndex, middleIndex);
        } else {
            int nextMiddleIndex = (rightIndex + middleIndex) / 2;
            if (nextMiddleIndex == middleIndex) {
            ...
            return search(nums, target, middleIndex, nextMiddleIndex, rightIndex);
        }
    }
}
